...
# 輸入退休年齡及餘命年限
retirement_age = st.number_input('請輸入退休年齡', min_value=60, max_value=65, value=61)
...
# 顯示每月可領的退休金
st.write(f'每月可領的退休金: {monthly_pension:.2f} 元')
st.write(f'總共可領的退休金: {years_pension:.2f} 元')
