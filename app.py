...
with tab3:
    ...
    Final60Tdata.loc[Final60Tdata.dateonly ==datetime(2024, 2, 15, 0, 0),'dateonly'] = datetime(2024, 2, 6, 0, 0)
    ...
    df_300.loc[df_300.dateonly ==datetime(2024, 2, 15, 0, 0),'dateonly'] = datetime(2024, 2, 6, 0, 0)
