...
with tab3:
    ...
    Final60Tdata.loc[Final60Tdata.dateonly ==datetime(2023, 1, 1, 0, 0),'dateonly'] = datetime(2023, 12, 29, 0, 0)
    ...
    df_300.loc[df_300.dateonly ==datetime(2023, 1, 1, 0, 0),'dateonly'] = datetime(2023, 12, 29, 0, 0)
